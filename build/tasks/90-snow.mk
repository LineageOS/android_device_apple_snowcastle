...
ifneq ($(LINEAGE_BUILD),)
INSTALLED_SNOW_TARGET := $(PRODUCT_OUT)/snowcastle-LineageOS-$(LINEAGE_VERSION).zip
else
INSTALLED_SNOW_TARGET ?= $(PRODUCT_OUT)/snowcastle-Android-$(PLATFORM_VERSION_LAST_STABLE)-$(BUILD_ID)-$(LOCAL_BUILD_DATE)-$(TARGET_PRODUCT).zip
endif
